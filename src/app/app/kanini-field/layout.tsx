        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-[13px] font-bold text-slate-800 flex items-center gap-1.5">
              Kanini Field <span className="text-[10px] font-mono bg-teal-50 text-teal-700 px-1.5 py-0.5 rounded border border-teal-200">FIELD APP</span>
              <span className="text-[10px] font-mono bg-slate-100 text-slate-600 px-1.5 py-0.5 rounded border border-slate-200">MarketLink</span>
            </div>
            <div className="text-[11px] text-slate-500">Outlet census · visits · intercepts · territory — live field operations via Kanini Field</div>
          </div>
        </div>
        <div className="flex items-center gap-2 text-[11px]">
          <span className="hidden sm:inline-flex items-center gap-1 text-slate-500">Superadmin view</span>
          <Link href="/portal/kanini" className="px-2.5 py-1.5 rounded-lg border border-slate-200 bg-slate-50 text-slate-600 hover:bg-white text-[11px]">Client portal →</Link>
        </div>
      </div>
