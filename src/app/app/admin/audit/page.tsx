...
const sampleData: AuditEntry[] = [
  {
    ...
    user: "Brian Mwangi",
    userEmail: "brian@playmaxagency.co.ke",
    action: "Login",
    target: "System",
  ...
  },
  {
    ...
    user: "Amina Mohamed",
    userEmail: "amina@playmaxagency.co.ke",
    action: "Create",
    target: "Lead",
    details:
  ...
  },
  {
    ...
    user: "Joy Kariuki",
    userEmail: "joy@playmaxagency.co.ke",
    action: "Update",
    target: "Booking",
  ...
  },
  {
    ...
    user: "Peter Odhiambo",
    userEmail: "peter@playmaxagency.co.ke",
    action: "Update",
    target: "Invoice",
  ...
  },
  {
    ...
    user: "Admin User",
    userEmail: "admin@playmaxagency.co.ke",
    action: "Update",
    target: "Staff Role",
