      ...
      <div className="p-7 space-y-6">
        ...
        <div className="grid grid-cols-4 gap-4">
          {[
            ...
            <div
              key={kpi.label}
              className="bg-black-2 border border-[#1e1e1e] rounded-lg p-5"
            >
        ...
        <div className="grid grid-cols-[2fr_1fr] gap-5">
          ...
          <div className="bg-black-2 border border-[#1e1e1e] rounded-lg p-5">
            <h3 className="text-[13px] font-semibold mb-4">Revenue by Type</h3>
        ...
        <div className="grid grid-cols-3 gap-5">
          ...
          <div className="bg-black-2 border border-[#1e1e1e] rounded-lg p-5">
            <h3 className="text-[13px] font-semibold mb-4">Lead Funnel</h3>
            {[
          ...
          {/* Top performers */}
          <div className="bg-black-2 border border-[#1e1e1e] rounded-lg p-5">
            <h3 className="text-[13px] font-semibold mb-4">Top Performers</h3>
            {[
              {
                name: "Amina Mwangi",
                deals: 4,
          ...
          {/* Channel performance */}
          <div className="bg-black-2 border border-[#1e1e1e] rounded-lg p-5">
            <h3 className="text-[13px] font-semibold mb-4">Lead Sources</h3>
            {[
